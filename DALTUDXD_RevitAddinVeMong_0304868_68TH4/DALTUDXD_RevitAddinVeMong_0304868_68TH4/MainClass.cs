    ...
    public class MainClass : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            PushButtonData buttonData = new PushButtonData("cmdHelloWorld",
               "Hello World", thisAssemblyPath, "DALTUDXD_RevitAddinVeMong_0304868_LOP68TH4.ExternalCommands.HelloWorldCommand");
            ...
            // b) large bitmap
            Uri uriImage = new Uri(@"D:\git\DALTUDXD_RevitAddinVeMong_0304868_LOP68TH4\DALTUDXD_RevitAddinVeMong_0304868_LOP68TH4\Assets\Icons\Cut_16px.png");
            ...
            PushButtonData buttonData_BoctachKL = new PushButtonData("cmdData_BoctachKL",
               "Quantity take-off", thisAssemblyPath, "DALTUDXD_RevitAddinVeMong_0304868_LOP68TH4.ExternalCommands.BocTachKhoiLuongCommand");
